...
## Diagnostics Framework v5 — Status
...
Build Matrix:         4/4 PASS
Unit Tests:           9/9 PASS
Pluggability:         Verified (emulator builds without Diagnostics)
Zero Overhead:        Verified (no code runs when SHARPEMU_DIAG not set)
```
...
# Via config file
echo '{"BootTimeline": true, "ImportTimeline": true}' > diagnostics.json
```

### Create a Plugin

See [docs/HOW_TO_CREATE_PLUGIN.md](docs/HOW_TO_CREATE_PLUGIN.md) — 5 minute guide.
