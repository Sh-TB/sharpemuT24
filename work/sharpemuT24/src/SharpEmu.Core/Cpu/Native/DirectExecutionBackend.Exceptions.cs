                        ...
                        if (exceptionCode == 2147483651u)
                        {
                                ...
                                if (rip == _ripTraceAddress1 || rip - 1 == _ripTraceAddress1)
                                {
                                        if (_ripTraceAddress1 != 0)
                                        {
                                                ...
                                                ulong t_rdx = ReadCtxU64(contextRecord, 136); ulong t_rbx = ReadCtxU64(contextRecord, 144); ulong t_r14 = ReadCtxU64(contextRecord, 232); ulong memVal = 0; try { memVal = *(ulong*)0x801E518C8UL; } catch { } ulong memVal2 = 0; try { memVal2 = *(ulong*)0x801E50DF0UL; } catch { } ulong memVal3 = 0; try { memVal3 = *(ulong*)0x801E50DF8UL; } catch { } Console.Error.WriteLine($"[RIP-TRACE] HIT slot=1 addr=0x{_ripTraceAddress1:X16} rip=0x{rip:X16} rax=0x{t_rax:X16} rcx=0x{t_rdi:X16} rdx=0x{t_rdx:X16} rbx=0x{t_rbx:X16} r14=0x{t_r14:X16} [0x801E518C8]=0x{memVal:X16} [0x801E50DF0]=0x{memVal2:X16} [0x801E50DF8]=0x{memVal3:X16}");
                                ...
                                if (rip == _ripTraceAddress2 || rip - 1 == _ripTraceAddress2)
                                {
                                        if (_ripTraceAddress2 != 0)
                                        {
                                                ...
                                                ulong t_rsi = ReadCtxU64(contextRecord, 136);
                                                ulong t_rax = ReadCtxU64(contextRecord, 120);
                                                ulong t_rdx = ReadCtxU64(contextRecord, 136); ulong t_rbx = ReadCtxU64(contextRecord, 144); ulong t_r14 = ReadCtxU64(contextRecord, 232); ulong memVal = 0; try { memVal = *(ulong*)0x801E518C8UL; } catch { } ulong memVal2 = 0; try { memVal2 = *(ulong*)0x801E50DF0UL; } catch { } ulong memVal3 = 0; try { memVal3 = *(ulong*)0x801E50DF8UL; } catch { } Console.Error.WriteLine($"[RIP-TRACE] HIT slot=2 addr=0x{_ripTraceAddress2:X16} rip=0x{rip:X16} rax=0x{t_rax:X16} rcx=0x{t_rdi:X16} rdx=0x{t_rdx:X16} rbx=0x{t_rbx:X16} r14=0x{t_r14:X16} [0x801E518C8]=0x{memVal:X16} [0x801E50DF0]=0x{memVal2:X16} [0x801E50DF8]=0x{memVal3:X16}");
                                ...
                                if (rip == _ripTraceAddress3 || rip - 1 == _ripTraceAddress3)
                                {
                                        if (_ripTraceAddress3 != 0)
                                        {
                                                ...
                                                ulong t_rsi = ReadCtxU64(contextRecord, 136);
                                                ulong t_rax = ReadCtxU64(contextRecord, 120);
                                                ulong t_rdx = ReadCtxU64(contextRecord, 136); ulong t_rbx = ReadCtxU64(contextRecord, 144); ulong t_r14 = ReadCtxU64(contextRecord, 232); ulong memVal = 0; try { memVal = *(ulong*)0x801E518C8UL; } catch { } ulong memVal2 = 0; try { memVal2 = *(ulong*)0x801E50DF0UL; } catch { } ulong memVal3 = 0; try { memVal3 = *(ulong*)0x801E50DF8UL; } catch { } Console.Error.WriteLine($"[RIP-TRACE] HIT slot=3 addr=0x{_ripTraceAddress3:X16} rip=0x{rip:X16} rax=0x{t_rax:X16} rcx=0x{t_rdi:X16} rdx=0x{t_rdx:X16} rbx=0x{t_rbx:X16} r14=0x{t_r14:X16} [0x801E518C8]=0x{memVal:X16} [0x801E50DF0]=0x{memVal2:X16} [0x801E50DF8]=0x{memVal3:X16}");
