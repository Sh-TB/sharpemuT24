...
public static partial class AgcExports
{
    ...
    public static int DriverSubmitDcb(CpuContext ctx)
    {
        ...
        // === BUG-C1 FIX: Diagnostic hook inline at AGC submit entry point ===
        // The previous DriverSubmitDcbWithDiag wrapper was dead code — the NID
        // resolver routes the game directly to this method, so the wrapper was
        // never called. We now call SharpEmu.Diagnostics.Contracts.DiagnosticAdapter.NotifyGpuSubmit() inline.
        try
        {
        ...
        catch { /* Diagnostics must never crash the emulator */ }
    ...
    public static int DriverSubmitAcb(CpuContext ctx)
    {
        ...
        // === BUG-C1 FIX: Diagnostic hook inline at ACB submit entry point ===
        try
        {
            if (SharpEmu.Diagnostics.Contracts.DiagnosticAdapter.IsActive)
            {
